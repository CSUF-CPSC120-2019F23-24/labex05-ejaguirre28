...
int main()
{
  ...
  std::cout << "\nThey are drifting apart as the get to 0" << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nThe number bein displayed in d3 is precise as opposed to f2, d3 displays the exact number with one decimal, while f2 is stated as being infinite" << std::endl;
